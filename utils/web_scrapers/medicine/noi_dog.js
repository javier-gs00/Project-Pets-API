...
module.exports = () => {
    return new Promise ((resolve, reject) => {
        console.log('==== Starting Noi Mascotas dog medicine web scraper ====')
        ...
        ((err, data) => {
            if (err) {
                console.log('Error fron Noi dog medicine web scraper...');
                reject(err)
            } else {
                let endTimer = timer(startTimer);
                console.log("== Noi Mascotas dog medicine web scraper completed in: " + endTimer + " ms ==")
                resolve(data)
            }
        })
    })
