...
module.exports = () => {
    return new Promise ((resolve, reject) => {
        console.log('==== Starting Tienda Pet dog medicine web scraper ====')
        let startTimer = timer();
        // Init scraper
        x(
            'https://www.tiendapet.cl/catalogo/perro/farmacia/',
            'div.block-producto',
            [{
        ...
        ((err, data) => {
            if (err) {
                console.log('Error fron Tienda Pet dog medicine web scraper...')
                reject(err)
            } else {
                let endTimer = timer(startTimer)
                console.log("== Tienda Pet dog medicine web scraper completed in: " + endTimer + " ms ==")
